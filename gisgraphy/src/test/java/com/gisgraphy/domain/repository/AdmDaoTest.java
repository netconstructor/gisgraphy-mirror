...
public class AdmDaoTest extends AbstractIntegrationHttpSolrTestCase {
	...
	List<Adm> ChildsLevel2 = GeolocTestHelper.createAdms("admchilds", "FR",
	...
	Adm parent = GeolocTestHelper.createAdm("admparent", "FR", "A1", null,
		null, null, null, 1);
	Adm child1 = GeolocTestHelper.createAdm("admchilds", "FR", "A1", "B2",
		null, null, null, 2);
	Adm child2 = GeolocTestHelper.createAdm("admchilds", "FR", "A1", "B2",
		null, null, null, 2);
	...
	try {
	    Adm adm = GeolocTestHelper.createAdm("adm", "FR", null, "B2", "C3",
		    "D4", null, 1);
	    admDao.save(adm);
	...
	try {
	    Adm adm = GeolocTestHelper.createAdm("adm", "FR", "A1", null, "C3",
		    "D4", null, 2);
	    admDao.save(adm);
	...
	try {
	    Adm adm = GeolocTestHelper.createAdm("adm", "FR", "A1", "B2", null,
		    "D4", null, 3);
	    admDao.save(adm);
	...
	try {
	    Adm adm = GeolocTestHelper.createAdm("adm", null, "A1", "B2", "C3",
		    "D4", null, 4);
	    admDao.save(adm);
	...
	Adm adm2 = GeolocTestHelper.createAdm("adm", "FR", "A1", "B2", null,
		null, null, 2);
	Adm savedAdm2 = this.admDao.save(adm2);
	Adm adm3 = GeolocTestHelper.createAdm("adm", "FR", "A1", "B2", "C3",
		null, null, 3);
	Adm savedAdm3 = this.admDao.save(adm3);
	Adm adm4 = GeolocTestHelper.createAdm("adm", "FR", "A1", "B2", "C3",
		"D4", null, 4);
	...
	Adm adm = GeolocTestHelper.createAdm("adm", "FR", "A1", null, null,
		null, null, 1);
	Adm savedAdm = this.admDao.save(adm);
	assertNotNull(savedAdm.getId());
	// check adm1 is saved
	...
	Adm admUsed = GeolocTestHelper.createAdm("adm_used", "FR", "A1", "B2",
		"C3", "D4", null, 4);
	Adm admUnUsed = GeolocTestHelper.createAdm("adm_unused", "FR", "A1",
		"B2", "C3", "D5", null, 4);
	...
	GisFeature gisFeature = GeolocTestHelper.createCity("gisFeature_city",
		1.3F, 45F, null);
	...
	Adm cleanAdm = GeolocTestHelper.createAdm("adm4_1", "FR", "A1", "B2",
		"C3", "D4", null, 4);
	cleanAdm.setFeatureId(cleanfeatureId);
	Adm durtyAdm = GeolocTestHelper.createAdm("adm4_2", "FR", "A1", "B2",
		"C3", "D5", null, 4);
	...
	Adm adm = GeolocTestHelper.createAdm("adm1_1", "FR", "A1", "B2", "C3",
		"D4", null, 4);
	assertEquals("A", adm.getFeatureClass());
    }
