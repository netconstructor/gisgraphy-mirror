...
public class FulltextQuerySolrHelper {
	...
	protected static final String NESTED_QUERY_INTEXT_WITHSTATE_TEMPLATE= "_query_:\"{!dismax qf='name^1.1 zipcode^1.1 all_adm1_name^0.5 all_adm2_name^0.5'  mm='1<-100%% 2<-50%% 3<-0%%' pf='all_adm1_name all_adm2_name' ps=6 bq='_val_:\"pow(population,0.3)\"' }%s\"";
