...
public class ImporterConfig {
	 ...
	 */
	public final static String DEFAULT_ACCEPT_REGEX = ImporterConfig.DEFAULT_FEATURE_CLASS + "[.].+;.[.]" + ImporterConfig.DEFAULT_FEATURE_CODE + ";A[.]ADM.?;A[.]PCL.?;";

	/**
	 * The regexp to use to import all the city
	 */
	public final static String DEFAULT_ACCEPT_REGEX_CITY = DEFAULT_ACCEPT_REGEX + "P[.]PPL[A-Z&&[^QW]];P[.]PPL$;P[.]STLMT$";
	...
	public void setAcceptRegExString(String acceptRegExString) {
		if (acceptRegExString == null) {
			logger.warn("the option acceptRegExString is not set and will be set to his default value : " + DEFAULT_ACCEPT_REGEX_OPTION);
